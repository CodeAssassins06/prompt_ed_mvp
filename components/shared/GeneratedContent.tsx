...
function GeneratedContent({ tutorial }: any) {
  ...
  const formattedCode = exampleCode?.code?.code?.join("\n");
  ...
  return (
    <div className="flex flex-col gap-12 w-full text-justify">
      <section className="flex gap-5 flex-col">
        <h1 className="h1-bold capitalize text-center text-primary-500 shadow-lg background-light700_dark400 py-2">
          {input}
        </h1>
      ...
      <section>
        <h1 className="h2-bold text-left text-center mb-4">
          Introduction to{" "}
          <span className="text-primary-500 capitalize">{input}</span>
        </h1>
      ...
      <section>
        <h1 className="h2-bold text-left text-center mb-4">
          <span className="text-primary-500 capitalize">Code Sample</span>
        </h1>
        <p className="">{exampleCode.beforeCodeExplanation}</p>
        <ParseHtml
          data={`<pre class="language-${exampleCode.code.languageName.toLowerCase()}"> <code>${formattedCode}</code></pre>`}
        />
        <p className="">{exampleCode.afterCodeExplanation}</p>
      </section>
                  ...
                  return (
                    <div
                      className={`flex items-center gap-2 ${
                        isCheck && testObject.correctOption === option
                          ? "text-green-600"
                          : ""
                      }`}
                      key={option}
                    >
                      <Input
                        className="font-[12px] w-min h-min"
                        type="radio"
